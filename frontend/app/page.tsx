          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-[var(--bg)] p-12 rounded-3xl border border-[var(--border)] relative overflow-hidden">
                ...
                <p className="text-[var(--text)] leading-relaxed relative z-10">
                  SheSignals uses an optimized <strong className="text-[#fe70d7]">XGBoost</strong> model to analyze structured responses from parents, guardians, and educators across 36 behavioral and developmental indicators. The model is enhanced with <strong className="text-[#fe70d7]">domain-level feature engineering</strong> — computing composite scores across social, sensory, emotional, communication, masking, and routine behaviors — bringing the total to 46 analytical dimensions. Trained with <strong className="text-[#fe70d7]">Bayesian hyperparameter optimization</strong> and a clinically tuned decision threshold, the system maximises recall to minimise missed cases. The result is a confidence-based recommendation that helps families determine whether seeking a specialist evaluation may be beneficial. The technology is designed to support early awareness and professional follow-up, not replace clinical diagnosis.
                </p>
            </div>
          </div>
        </div>
